        ...
        <div v-for="(element,index) in list" :key="element.id" class="list-complete-item" style="background-color: #f4f4f4;border: 0;">
          ...
          <div style="display: flex; align-items: center;flex-direction: column;justify-content: center;">
              <div style="display: flex;flex-direction: column;align-items: center;justify-content: center;padding: 10px;">
                <el-input v-model="element.title" placeholder="分类名称" size="mini" style="margin-bottom: 10px;"></el-input>
                ...
                <div v-if="element.type" style="margin-top: 10px;">
                    ...
                    <el-input size="mini" v-else v-model="element.url" placeholder="请输入要跳转的链接" clearable></el-input>
                </div>
             </div>
          </div>
